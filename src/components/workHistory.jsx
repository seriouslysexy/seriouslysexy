...
const workHistoryArray = [
	{
		...
		responsibilities: [
			"Created and actively maintain an internal tool which has dramatically accelerated development company-wide and automated thousands of man-hours",
			"Contributed to the development and maintenance of 10+ distinct NodeJS microservices",
			"Collaborated with team members, product managers, and executive stakeholders to plan and deliver a rewrite of a full-fledged GUI from AngularJS (v1) to ReactJS",
			"Regularly coordinate with engineering and product teams to architect and implement solutions that meet the requirements of all parties and meet delivery dates",
